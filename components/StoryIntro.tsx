      ...
      <div className="section__inner">
        ...
        <div className="comic-panel panel stagger">
          <p style={{ fontSize: '1.05rem', lineHeight: 2, color: '#333' }}>
            ...
            unserem Projekt <strong>&bdquo;Meum Diarium – Ein Feldherr als Influencer&rdquo;</strong> den <strong>Deutschen Multimediapreis</strong> gewonnen.
            Hierfür haben wir eine Website erstellt, auf der
            <strong> Gaius Julius Caesar</strong> aus seiner subjektiven Sicht ein unterhaltsames Tagebuch über
            seine Feldzüge und andere historische Ereignisse geschrieben hat. Mit viel Liebe zum Detail haben
          ...
          <p className="mt-16" style={{ fontSize: '1.05rem', lineHeight: 2, color: '#333' }}>
            ...
            <strong> digitalen Medien</strong> machen, als Technik-Team an unserer Schule Veranstaltungen organisieren oder selbst auf der Bühne stehen: Wir lieben es, Projekte umzusetzen oder uns über kreative Ideen auszutauschen.
          </p>
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: 1.8, color: 'var(--red)', fontWeight: 700, fontStyle: 'italic' }}>
            Als ehemalige Preisträger würden wir, Benedikt und Vinzenz, uns sehr freuen, wenn wir uns im Jugendbeirat einbringen und mithelfen können.
          </p>
        </div>
      </div>
    </section>
